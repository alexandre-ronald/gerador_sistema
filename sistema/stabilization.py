...
def ownership_required(view_func):
    """Ensure URL-addressed systems belong to the authenticated user."""
    @wraps(view_func)
...
def _save_payload(request, data, sistema):
...
def atualizar_sistema_seguro(request, sistema_id):
    ...
    try:
        ...
        with transaction.atomic():
            _save_payload(request, data, sistema)
