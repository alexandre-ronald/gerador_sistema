...
class Sistema(models.Model):
    ...
    usar_custom_user = models.BooleanField(default=False, verbose_name="Gerar Custom User Model?")
...
class Campo(models.Model):
    TIPO_CAMPO_CHOICES = [
        ...
        ("ImageField", "ImageField"), ("ForeignKey", "ForeignKey"), ("ManyToManyField", "ManyToManyField"),
    ...
    default_value = models.CharField(max_length=255, blank=True, help_text="Valor padrão literal (ex: Ativo, True, 0)")
    ...
    related_name = models.CharField(max_length=100, blank=True, verbose_name="Related Name")
