...
class EquipamentoForm(forms.ModelForm):
    class Meta:
        ...
        model = apps.get_model('monitor', 'Equipamento')
        fields = '__all__'
...
class Tipo_IntercorrenciaForm(forms.ModelForm):
    class Meta:
        # Buscamos o modelo dinamicamente para garantir que ele já foi carregado
        model = apps.get_model('monitor', 'Tipo_Intercorrencia')
        fields = '__all__'
...
class IntercorrenciaForm(forms.ModelForm):
    class Meta:
        # Buscamos o modelo dinamicamente para garantir que ele já foi carregado
        model = apps.get_model('monitor', 'Intercorrencia')
        fields = '__all__'
