...
urlpatterns = [
    ...
    # Compatibilidade: qualquer rota de geração usa o único pipeline canônico.
    path('sistema/gerar/<int:pk>/', installer_views.processar_geracao_ajax, name='gerar_sistema1'),
