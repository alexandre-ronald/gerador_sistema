...
class CompilationPlan:
    ...
    def artifacts(self) -> tuple[GenerationArtifact, ...]:
        ...
        if spec.audit:
            result.extend([GenerationArtifact("auditoria/__init__.py","audit"),GenerationArtifact("auditoria/apps.py","audit"),GenerationArtifact("auditoria/models.py","audit"),GenerationArtifact("auditoria/admin.py","audit"),GenerationArtifact("auditoria/request_context.py","audit"),GenerationArtifact("auditoria/middleware.py","audit"),GenerationArtifact("auditoria/signals.py","audit"),GenerationArtifact("auditoria/migrations/__init__.py","audit"),GenerationArtifact("auditoria/migrations/0001_initial.py","audit")])
