...
class GeneratedAdvancedPageTemplateTests(SimpleTestCase):
    ...
    def test_generation_projects_crud_report_and_workflow_actions(self):
        ...
        self.assertEqual(actions["aprovar_contrato"]["model_name"], "Contrato")
    ...
    def test_generated_page_template_is_valid_django_template(self):
        ...
        self.assertIn("{% if advanced_component_aprovar_confirm %}", source)
        self.assertIn("{{ advanced_component_aprovar_confirm_message }}", source)
        self.assertIn("advancedWorkflowConfirm_advanced_component_aprovar", source)
    ...
    def test_runtime_emits_component_binding_and_action_contract(self):
        ...
        self.assertIn('"model_name": "Contrato"', source)
        ...
        self.assertIn("_workflow_confirmation", source)
        self.assertIn('fromlist=["WORKFLOWS"]', source)
